package skyline.ui{
	...
	*/
	...
	public class NavSkyline extends Sprite {
		...
		public function get nodeArray():Array { return _nodeArray; }
		...
		public function create ():void{
			...
			_cityProgressBoard.x = 900 - CityProgressBoard.EXPANDED_WIDTH;
		...
		public function select (id:int):void{
			...
			_cityProgressBoard.expandForestPane(toX, 0);
			//brighten forest if on this node's first select
			var currNode:NavNodeSkyline = _nodeArray[id];
			if (currNode.selectCount == 1){
				_cityProgressBoard.forestPane.reveal(_nodeArray.length);
			}
		...
		private function onPaneTimer(event:TimerEvent):void {
			...
			_cityProgressBoard.collapseForestPane(toX, 0);
		}
